...
<x-backend-form-multiple name="invoices" :values="$customers->pluck('invoices')->flatten()"
    :selecteds="isset($resource) ? $resource->invoices : []" grouped old-filter-fields="invoice_id,imputed_amount"
    contents-size="xxl" contents-view="pos::payment.create.invoice" data-type="payment"
...
<x-backend-form-controls
    ...
    cancel="pos::payment.cancel" cancel-route="backend.payment" />
