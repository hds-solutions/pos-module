...
@section('description', __('pos::pos.description'))
        ...
        <div class="row collapse @if (request()->has('filters')) show @endif" id="filters">
            <form action="{{ route('backend.pos') }}"
                ...
                <x-backend-form-foreign name="filters[branch]" id="filter-branch"
                    ...
                    label="inventory::pos.branch_id.0"
                    placeholder="inventory::pos.branch_id._"
                    {{-- helper="inventory::pos.branch_id.?" --}} />
        ...
        @else
            <div class="text-center m-t-30 m-b-30 p-b-10">
                ...
                <p class="text-muted">
                    ...
                    <a href="{{ route('backend.pos.create') }}" class="text-custom">
                        <ins>@lang('pos::pos.create')</ins>
                    </a>
                </p>
            </div>
        @endif
