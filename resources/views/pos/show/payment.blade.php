<div class="col-10 col-lg-11">
    ...
    <div class="form-row mt-2" data-only="payments[payment_type][]={{ \HDSSolutions\Finpar\Models\Payment::PAYMENT_TYPE_Credit }}">
    ...
    <div class="form-row mt-2" data-only="payments[payment_type][]={{ \HDSSolutions\Finpar\Models\Payment::PAYMENT_TYPE_Check }}">
        <div class="col offset-2">
            {{-- Check --}}
    ...
    <div class="form-row mt-2" data-only="payments[payment_type][]={{ \HDSSolutions\Finpar\Models\Payment::PAYMENT_TYPE_CreditNote }}">
        <div class="col offset-2">
            {{-- CreditNote --}}
    ...
    <div class="form-row mt-2" data-only="payments[payment_type][]={{ \HDSSolutions\Finpar\Models\Payment::PAYMENT_TYPE_Promissory }}">
        <div class="col offset-2">
            TODO: Promissory
        </div>
    </div>
    <div class="form-row mt-2" data-only="payments[payment_type][]={{ \HDSSolutions\Finpar\Models\Payment::PAYMENT_TYPE_Card }}">
        <div class="col offset-2">
