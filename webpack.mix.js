...
mix.options({
    fileLoaderDirs: {
        images: 'pos-module/assets/images',
        fonts: 'pos-module/assets/fonts',
    }
});
...
mix
     ...
     ** *********************** **/
    .js('resources/assets/js/app.js',       'pos-module/assets/js')
    .sass('resources/assets/sass/app.scss', 'pos-module/assets/css')
    .copy('resources/assets/images',        public+'/pos-module/assets/images')
